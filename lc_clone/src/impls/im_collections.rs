//! LcClone implementations for the `im` crate's persistent collections.
//!
...
impl<K, V> LcClone for im::HashMap<K, V>
where
...
impl<K, V> LcClone for im::OrdMap<K, V>
where
    K: Clone + Ord,
    V: Clone,
{
...
impl<T> LcClone for im::HashSet<T>
where
...
impl<T> LcClone for im::OrdSet<T>
where
    T: Clone + Ord,
{
    #[inline]

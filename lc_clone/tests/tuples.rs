...
fn nested_tuple_preserves_arc_sharing() {
    ...
    let tuple = ((shared.lc(), 1i32), (2i32, shared.lc()));
    let cloned = tuple.lc();
...
fn all_tuple_sizes_compile() {
    ...
    let _t1 = (1i32,).lc();
    let _t2 = (1i32, 2i32).lc();
    let _t3 = (1i32, 2i32, 3i32).lc();
    let _t4 = (1i32, 2i32, 3i32, 4i32).lc();
    let _t5 = (1i32, 2i32, 3i32, 4i32, 5i32).lc();
    let _t6 = (1i32, 2i32, 3i32, 4i32, 5i32, 6i32).lc();
    let _t7 = (1i32, 2i32, 3i32, 4i32, 5i32, 6i32, 7i32).lc();
    let _t8 = (1i32, 2i32, 3i32, 4i32, 5i32, 6i32, 7i32, 8i32).lc();
    let _t9 = (1i32, 2i32, 3i32, 4i32, 5i32, 6i32, 7i32, 8i32, 9i32).lc();
    let _t10 = (1i32, 2i32, 3i32, 4i32, 5i32, 6i32, 7i32, 8i32, 9i32, 10i32).lc();
    let _t11 = (

#!/bin/bash
# Egress firewall for Claude Code sandbox
# Based on: https://github.com/anthropics/claude-code/blob/main/.devcontainer/init-firewall.sh
#
# Whitelists: GitHub, npm, NuGet, PyPI, Anthropic API, VS Code marketplace
...
echo ""
echo "Firewall is active. Safe to use: claude --dangerously-skip-permissions"
